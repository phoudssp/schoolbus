...
window.APP_I18N = {
  en: {
    ...
    studentsPage: {
      ...
      qr: 'ID card',
      printQr: 'Print card',
      generateQr: 'Issue card',
      regenerateQr: 'Regenerate token',
      linkGuardian: 'Link to guardian',
      cardFront: 'Front',
      cardBack: 'Back',
      cardIssued: 'Card issued',
      cardInstructions: 'Tap on the bus reader OR scan the QR code to board.',
      tapZone: 'Tap on the bus reader',
      nfcUid: 'NFC UID',
      cardId: 'Card ID',
      issuedOn: 'Issued',
      cardIssuedToast: 'Card issued — both NFC tap and QR scan ready'
    },
  ...
  lo: {
    ...
    studentsPage: {
      ...
      cardFront: 'ດ້ານໜ້າ',
      cardBack: 'ດ້ານຫຼັງ',
      cardIssued: 'ອອກບັດແລ້ວ',
      cardInstructions: 'ແຕະທີ່ເຄື່ອງອ່ານ ຫຼື ສະແກນ QR ເພື່ອຂຶ້ນລົດ.',
      tapZone: 'ແຕະທີ່ນີ້',
      nfcUid: 'NFC UID',
      cardId: 'ລະຫັດບັດ',
      issuedOn: 'ອອກວັນທີ',
      cardIssuedToast: 'ອອກບັດແລ້ວ — ໃຊ້ໄດ້ທັງ NFC ແລະ QR'
    },
